...
export const OBJECTS: Record<string, PhysicsObject> = {
  bowling: { id: 'bowling', name: 'Bola de Boliche', mass: 7.26, area: 0.037, cd: 0.47, color: '#1e293b', radius: 120, image: '/objetos/bola de boliche.png' },
  soccer: { id: 'soccer', name: 'Bola de Futebol', mass: 0.43, area: 0.037, cd: 0.25, color: '#f8fafc', radius: 120, image: '/objetos/bola de futebol.png' },
  golf: { id: 'golf', name: 'Bola de Golfe', mass: 0.046, area: 0.0014, cd: 0.3, color: '#e2e8f0', radius: 70, image: '/objetos/bola de golf.png' },
  pingpong: { id: 'pingpong', name: 'Bola de Ping-Pong', mass: 0.0027, area: 0.0014, cd: 0.4, color: '#f97316', radius: 70, image: '/objetos/bola de ping-pong.png' },
